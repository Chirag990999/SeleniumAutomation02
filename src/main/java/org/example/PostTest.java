...
public class PostTest {
    ...
    @Test
    public void it_Should_Product_Valid_DataComments(){
        Response response = given()
                .when()
                .get("comments")
                .then()
    ...
    public void it_should_create_new_post2(){
        ...
        JsonPath jsonPath =response.jsonPath();
        String postId = jsonPath.getString( "postId" );
        String name = jsonPath.get("name");
        String email = jsonPath.getString( "email" );
        String body = jsonPath.getString( "body" );
        Assert.assertEquals( postId,"1" );
        Assert.assertEquals( name,"Jon Doe" );
        Assert.assertEquals( email,"jon.doe@amazon.com" );
        Assert.assertEquals( body,"this is jon doe" );
    }
}
